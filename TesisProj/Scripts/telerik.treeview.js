(function ($, undefined) {
    ...
    TreeView = $t.treeview = function (element, options) {
        ...
        $element
            ...
            .delegate('.t-plus, .t-minus', 'touchend click', $t.delegate(this, this.nodeClick));
                    ...
                    if (e.keyCode == 27) {
                        ...
                        if ($dropCue.css('visibility') == 'visible') {
                            ...
                            if (targetGroup.length === 0) {
                                ...
                                if (!treeview.isAjax() || !destinationItem.find(">div >.t-icon").length) {
    ...
    TreeView.prototype = {
        ...
        dataBind: function ($item, data) {
            ...
            $t.fx.play(this.effects, group, { direction: 'bottom' });
