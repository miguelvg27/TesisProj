...
namespace TesisProj.Areas.Simulaciones.Controllers
{
    public class WeibullController : Controller
    {
        ...
        {
            ModeloSimulacion modelo = new ModeloSimulacion("Weibull");
        ...
        public ActionResult Index(_Weibull b)
        {
            ...
            ModeloSimulacion modelo = new ModeloSimulacion("Weibull", b.ParamsIN[0].valorD, b.ParamsIN[1].valorD, 0, 0);
        ...
        {
            ModeloSimulacion m = new ModeloSimulacion("Weibull");
            byte[] byteArray;
            if (Id == -1)
