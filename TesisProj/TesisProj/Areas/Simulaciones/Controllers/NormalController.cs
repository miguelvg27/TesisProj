...
namespace TesisProj.Areas.Simulaciones.Controllers
{
    public class NormalController : Controller
    {
        ...
        {
            ModeloSimulacion modelo = new ModeloSimulacion("Normal");
        ...
        public ActionResult Index(_Normal u)
        {
            ...
            ModeloSimulacion modelo = new ModeloSimulacion("Normal", u.ParamsIN[0].valorD, u.ParamsIN[1].valorD, 0, 0);
        ...
        {
            ModeloSimulacion m = new ModeloSimulacion("Normal");
            byte[] byteArray;
            if (Id == -1)
