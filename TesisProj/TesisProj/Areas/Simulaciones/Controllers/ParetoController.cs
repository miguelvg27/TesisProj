...
namespace TesisProj.Areas.Simulaciones.Controllers
{
    public class ParetoController : Controller
    {
        ...
        {
            ModeloSimulacion modelo = new ModeloSimulacion("Pareto");
        ...
        public ActionResult Index(_Pareto u)
        {
            ...
            ModeloSimulacion modelo = new ModeloSimulacion("Pareto", u.ParamsIN[0].valorD, u.ParamsIN[1].valorD, 0, 0);
        ...
        {
            ModeloSimulacion m = new ModeloSimulacion("Pareto");
            byte[] byteArray;
            if (Id == -1)
