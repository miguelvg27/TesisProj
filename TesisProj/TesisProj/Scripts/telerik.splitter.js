(function ($) {
    ...
    $t.splitter.prototype = {
        toggle: function(pane, expand) {
            ...
            previousSplitBar.find(".t-collapse-prev").toggle(expand).end().find(".t-collapse-next").toggle(!expand);
            ...
            nextSplitBar.find(".t-collapse-next").toggle(expand).end().find(".t-collapse-prev").toggle(!expand);
