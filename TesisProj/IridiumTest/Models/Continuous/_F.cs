...
namespace IridiumTest.Models.Continuous
{
    public class _F : Datos
    {
        ...
        {
            this.Titulo = "FisherSnedecor (F)";
            this.Resumen = Img.Image2Bytes(_String.patchImgF + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgF + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgF+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgF+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgF+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgF+"PX.png")},
            };
