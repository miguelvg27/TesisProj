...
namespace IridiumTest.Models.Continuous
{
    public class _Exponencial : Datos
    {
        ...
        public _Exponencial(double rate)
        {
        ...
        private void CrearComplemento()
        {
            ...
            this.Resumen = Img.Image2Bytes(_String.patchImgExponencial + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgExponencial + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgExponencial+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgExponencial+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgExponencial+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgExponencial+"PX.png")},
            };
