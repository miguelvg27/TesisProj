...
namespace IridiumTest.Models.Continuous
{
    public class _Weibull:Datos
    {
        ...
        {
            this.Titulo = "Weibull";
            this.Resumen = Img.Image2Bytes(_String.patchImgWeibull + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgWeibull + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgWeibull+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgWeibull+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgWeibull+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgWeibull+"PX.png")},
            };
