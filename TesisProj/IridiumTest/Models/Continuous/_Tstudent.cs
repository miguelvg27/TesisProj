...
namespace IridiumTest.Models.Continuous
{
    public class _TStudent:Datos
    {
        ...
        public _TStudent(double location, double scale, double freedom)
        {
        ...
        {
            this.Titulo = "T Student";
            this.Resumen = Img.Image2Bytes(_String.patchImgTStudent + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgTStudent + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgTStudent+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgTStudent+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgTStudent+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgTStudent+"PX.png")},
            };
