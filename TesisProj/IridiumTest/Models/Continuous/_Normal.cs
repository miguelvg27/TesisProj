...
namespace IridiumTest.Models.Continuous
{
    public class _Normal : Datos
    {
        ...
        {
            this.Titulo = "Normal";
            this.Resumen = Img.Image2Bytes(_String.patchImgNormal + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgNormal + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgNormal+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgNormal+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgNormal+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgNormal+"PX.png")},
            };
