...
namespace IridiumTest.Models.Discrete
{
    public class _Binomial : Datos
    {
        ...
        private void CrearComplemento()
        {
            ...
            this.Resumen = Img.Image2Bytes(_String.patchImgBinomial + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgBinomial + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgBinomial+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgBinomial+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgBinomial+"y1.png")},
                            new Formulate { NombreFormula="y2=", Imagen=Img.Image2Bytes(_String.patchImgBinomial+"y2.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgBinomial+"PX.png")},
            };
