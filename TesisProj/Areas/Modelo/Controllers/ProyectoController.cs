...
namespace TesisProj.Areas.Modelo.Controllers
{
    ...
    public partial class ProyectoController : Controller
    {
        ...
        public static SimAns simular(int horizonte, int preoperativos, int cierre, List<Operacion> operaciones, List<Parametro> parametros, List<Formula> formulas, List<TipoFormula> tipoformulas)
        {
            SimAns resultado = new SimAns { TirE = 0, TirF = 0, VanE = 0, VanF = 0 };

            CalcularProyecto(horizonte, preoperativos, cierre, operaciones, parametros, formulas, tipoformulas, true);
