...
namespace TesisProj.Areas.CompararProyecto.Controllers
{
    ...
    public class CompararVersionesController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            Session["Id"] = id;
            i = new int[100];
            c = StaticProyecto.getVersionesList(context, id);
        ...
        public ActionResult Index(int[] checkedRecords)
        {
           ...
           ViewData["Versiones"] = listaversiones; 
            ...
            {
                graficosVanE.Add(new Graphic { N = proyecto.Version, fx = proyecto.VanE });
                graficosVanF.Add(new Graphic { N = proyecto.Version, fx = proyecto.VanF });
                graficosTirE.Add(new Graphic { N = proyecto.Version, fx = proyecto.TirE });
                graficosTirF.Add(new Graphic { N = proyecto.Version, fx = proyecto.TirF });
            }
