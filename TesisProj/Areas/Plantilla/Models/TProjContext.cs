...
namespace TesisProj.Models.Storage
{
    public partial class TProjContext : DbContext
    {
        ...
        public void SeedPlantillaFormulas()
        {
            ...
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Inversión", IdTipoDato = 3, Referencia = "inversion", Secuencia = 50, IdTipoFormula = 27, IdPlantillaElemento = 1, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Cadena = "valorInicial", Visible = false });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Período final", IdTipoDato = 1, Referencia = "periodoFinal", Secuencia = 10, IdTipoFormula = 7, IdPlantillaElemento = 2, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte", Cadena = "PeriodosPreOperativos + vidaUtil", Visible = false });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Amortización", IdTipoDato = 3, Referencia = "amortizacion", Secuencia = 20, IdTipoFormula = 5, IdPlantillaElemento = 2, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Cadena = "DepreciacionLineal(valorInicial, vidaUtil, PeriodosPreOperativos + 1, Periodo)", Visible = true });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Inversión inicial", IdTipoDato = 3, Referencia = "inversionInicial", Secuencia = 30, IdTipoFormula = 6, IdPlantillaElemento = 2, PeriodoInicial = "PeriodosPreOperativos", PeriodoFinal = "PeriodosPreOperativos", Cadena = "valorInicial", Visible = true });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Inversión", IdTipoDato = 3, Referencia = "inversion", Secuencia = 40, IdTipoFormula = 28, IdPlantillaElemento = 2, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Cadena = "valorInicial", Visible = false });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Valor unitario mineral", IdTipoDato = 3, Referencia = "valorUnitario", Secuencia = 10, IdTipoFormula = 10, IdPlantillaElemento = 3, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = false, Cadena = "ley * precioMetal * recuperacion" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Ventas", IdTipoDato = 3, Referencia = "ventas", Secuencia = 20, IdTipoFormula = 8, IdPlantillaElemento = 3, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = true, Cadena = "valorUnitario * tamanoMina" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Costos", IdTipoDato = 3, Referencia = "costos", Secuencia = 30, IdTipoFormula = 9, IdPlantillaElemento = 3, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = true, Cadena = "costoProduccion * tamanoMina + costoFijo" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Gasto administrativo", IdTipoDato = 3, Referencia = "administrativo", Secuencia = 10, IdTipoFormula = 11, IdPlantillaElemento = 4, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = true, Cadena = "monto" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Préstamo", IdTipoDato = 3, Referencia = "prestamo", Secuencia = 10, IdTipoFormula = 16, IdPlantillaElemento = 5, PeriodoInicial = "periodoInicial", PeriodoFinal = "periodoInicial", Visible = true, Cadena = "valorInicial" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Amortización", IdTipoDato = 3, Referencia = "amortizacion", Secuencia = 20, IdTipoFormula = 13, IdPlantillaElemento = 5, PeriodoInicial = "periodoInicial + periodosGracia + 1", PeriodoFinal = "periodoInicial + periodosGracia + plazo", Visible = true, Cadena = "Amortizacion(tasa, (Periodo - periodoInicial - periodosGracia), plazo, valorInicial)" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Intereses gracia", IdTipoDato = 3, Referencia = "igracia", Secuencia = 30, IdTipoFormula = 15, IdPlantillaElemento = 5, PeriodoInicial = "periodoInicial + 1", PeriodoFinal = "periodoInicial + periodosGracia", Visible = true, Cadena = "Intereses(tasa, 1, plazo, valorInicial)" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Intereses", IdTipoDato = 3, Referencia = "intereses", Secuencia = 40, IdTipoFormula = 15, IdPlantillaElemento = 5, PeriodoInicial = "periodoInicial + periodosGracia + 1", PeriodoFinal = "periodoInicial + periodosGracia + plazo", Visible = true, Cadena = "Intereses(tasa, (Periodo - periodoInicial - periodosGracia), plazo, valorInicial)" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Cuota", IdTipoDato = 3, Referencia = "cuota", Secuencia = 50, IdTipoFormula = 14, IdPlantillaElemento = 5, PeriodoInicial = "periodoInicial + 1", PeriodoFinal = "periodoInicial + periodosGracia + plazo", Visible = true, Cadena = "amortizacion + igracia + intereses" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Inversión", IdTipoDato = 3, Referencia = "inversion", Secuencia = 60, IdTipoFormula = 25, IdPlantillaElemento = 5, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = false, Cadena = "valorInicial" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Costo capital", IdTipoDato = 3, Referencia = "costoCapital", Secuencia = 70, IdTipoFormula = 17, IdPlantillaElemento = 5, PeriodoInicial = "1", PeriodoFinal = "1", Visible = false, Cadena = "tasa * inversion" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Tasa", IdTipoDato = 4, Referencia = "tasanual", Secuencia = 10, IdTipoFormula = 18, IdPlantillaElemento = 6, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = true, Cadena = "tasa" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Tasa", IdTipoDato = 4, Referencia = "tasanual", Secuencia = 10, IdTipoFormula = 19, IdPlantillaElemento = 7, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = true, Cadena = "tasa" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Tasa", IdTipoDato = 4, Referencia = "tasanual", Secuencia = 10, IdTipoFormula = 19, IdPlantillaElemento = 8, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = true, Cadena = "tasa" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Tasa", IdTipoDato = 4, Referencia = "tasanual", Secuencia = 10, IdTipoFormula = 20, IdPlantillaElemento = 9, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = true, Cadena = "tasa" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Aporte", IdTipoDato = 3, Referencia = "aporteInicial", Secuencia = 10, IdTipoFormula = 21, IdPlantillaElemento = 10, PeriodoInicial = "periodoInicial", PeriodoFinal = "periodoInicial", Visible = true, Cadena = "aporte" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Inversión", IdTipoDato = 3, Referencia = "inversion", Secuencia = 20, IdTipoFormula = 26, IdPlantillaElemento = 10, PeriodoInicial = "1", PeriodoFinal = "Horizonte", Visible = false, Cadena = "aporte" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Costo capital", IdTipoDato = 3, Referencia = "costoCapital", Secuencia = 30, IdTipoFormula = 22, IdPlantillaElemento = 10, PeriodoInicial = "1", PeriodoFinal = "1", Visible = false, Cadena = "tasa * inversion" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Aporte", IdTipoDato = 3, Referencia = "aporteInicial", Secuencia = 10, IdTipoFormula = 21, IdPlantillaElemento = 11, PeriodoInicial = "periodoInicial", PeriodoFinal = "periodoInicial", Visible = true, Cadena = "aporte" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Plan de cierre", IdTipoDato = 3, Referencia = "planCierre", Secuencia = 10, IdTipoFormula = 21, IdPlantillaElemento = 12, PeriodoInicial = "Horizonte - PeriodosCierre + 1", PeriodoFinal = "Horizonte - PeriodosCierre + 1", Visible = true, Cadena = "montoInicial" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Plan de postcierre", IdTipoDato = 3, Referencia = "planPostCierre", Secuencia = 20, IdTipoFormula = 21, IdPlantillaElemento = 12, PeriodoInicial = "Horizonte - PeriodosCierre + 2", PeriodoFinal = "Horizonte", Visible = true, Cadena = "(presupuesto - montoInicial)/(PeriodosCierre - 1)" });
            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Gasto de garantías", IdTipoDato = 3, Referencia = "garantia", Secuencia = 30, IdTipoFormula = 29, IdPlantillaElemento = 12, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = true, Cadena = "(presupuesto / (Horizonte - PeriodosPreOperativos - PeriodosCierre)) * costoGarantia * (Periodo - PeriodosPreOperativos)" });

            PlantillaFormulasRequester.AddElement(new PlantillaFormula { Nombre = "Monto", IdTipoDato = 3, Referencia = "monto", Secuencia = 10, IdTipoFormula = 23, IdPlantillaElemento = 13, PeriodoInicial = "PeriodosPreOperativos + 1", PeriodoFinal = "Horizonte - PeriodosCierre", Visible = true, Cadena = "otroingreso" });
