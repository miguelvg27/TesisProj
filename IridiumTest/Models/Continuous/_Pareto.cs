...
namespace IridiumTest.Models.Continuous
{
    public class _Pareto:Datos
    {
        ...
        public _Pareto(double scale, double shape)
        {
        ...
        {
            this.Titulo = "Pareto";
            this.Resumen = Img.Image2Bytes(_String.patchImgPareto + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgPareto + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgPareto+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgPareto+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgPareto+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgPareto+"PX.png")},
            };
