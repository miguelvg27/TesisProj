...
namespace IridiumTest.Models.Discrete
{
    public class _UniformeDiscreta:Datos
    {
        ...
        {
            this.Titulo = "Uniforme Discreta";
            this.Resumen = Img.Image2Bytes(_String.patchImgUniformeDiscreta + "Resumen.png");
            ...
            Imagen = Img.Image2Bytes(_String.patchImgUniformeDiscreta + "Imagen.png");
            ...
            this.Formulates = new List<Formulate> {
                            new Formulate { NombreFormula="E(X)=", Imagen=Img.Image2Bytes(_String.patchImgUniformeDiscreta+"EX.png")},
                            new Formulate { NombreFormula="D(X)=", Imagen=Img.Image2Bytes(_String.patchImgUniformeDiscreta+"DX.png")},
                            new Formulate { NombreFormula="y1=", Imagen=Img.Image2Bytes(_String.patchImgUniformeDiscreta+"y1.png")},
                            new Formulate { NombreFormula="P(X=r)", Imagen=Img.Image2Bytes(_String.patchImgUniformeDiscreta+"PX.png")},
            };
        ...
        public _UniformeDiscreta(int lower,int upper)
        {
